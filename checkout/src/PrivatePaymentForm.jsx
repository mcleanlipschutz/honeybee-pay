...
export function PrivatePaymentForm({ request, wallet, transact, disabled, isCurrent }) {
  ...
  return <div className="private-payment-check">
    ...
    <form ref={form} onSubmit={submit}>
      ...
      {current && <button type="submit" name="action" value="payment-submit" className="primary" disabled={busy || disabled}>Confirm private payment · {formatUnits(BigInt(payment.quote.totalUnits), 6)} test USDC + {formatUnits(BigInt(payment.quote.feeUnits), 18)} Sepolia WETH fee</button>}
