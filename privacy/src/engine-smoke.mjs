...
import { ArtifactStore, startRailgunEngine, stopRailgunEngine,
  ...
  validateRailgunAddress } from '@railgun-community/wallet';
...
export async function checkEngine() {
  ...
  try {
    ...
    return { status: 'offline-engine-wallet-check-passed', walletsCreated: 2,
      encryptedWalletReloaded: true, wrongKeyRejected, funded: false, proofGenerated: false, paymentReady: false };
  } finally {
    keyBytes.fill(0);
